...
function injetarCenaAR() {
    ...
    const w = isPortrait ? 960 : 1280;
    const h = isPortrait ? 1280 : 960;

    // Removi o 'look-controls' da câmara porque sem sticky não precisamos de giroscópio
    const html = `
        <a-scene embedded
...
function iniciarCena3D(ponto) {
    ...
    hitbox.setAttribute('scale', '1 1.5 1');
